...
export function getLodop(oOBJECT, oEMBED) {
    ...
    var strCLodopInstall = "<br><font color='#FF00FF'>CLodop云打印服务(localhost本地)未安装启动!点击这里<a href='http://www.mtsoftware.cn/download/CLodop_Setup_for_Win32NT_https_3.083Extend.zip' target='_self'>执行安装</a>,安装后请刷新页面。</font>";
        ...
        if (needCLodop()) {
            ...
            if (!LODOP) {
                if (isIE) document.write(strCLodopInstall); else {
                    ...
                    document.getElementById('printerid').innerHTML = strCLodopInstall;
                    Message({
                        type: type,
                        dangerouslyUseHTMLString: true,
                        showClose: true,
                        message: '打印控件未安装!请先安装'
                    });
                }
                return;
            } else {
